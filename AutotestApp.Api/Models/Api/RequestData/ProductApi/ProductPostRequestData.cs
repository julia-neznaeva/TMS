...
{
    public class ProductPostRequestData : IProductRequestData
    {
        [JsonProperty("ID")]
        ...
        public string PriceTier1 { get; set; } = "0";

        [JsonProperty("PriceTier2")]
        public string PriceTier2 { get; set; } = "0";

        [JsonProperty("PriceTier3")]
        public string PriceTier3 { get; set; } = "0";

        [JsonProperty("PriceTier4")]
        public string PriceTier4 { get; set; } = "0";

        [JsonProperty("PriceTier5")]
        public string PriceTier5 { get; set; } = "0";

        [JsonProperty("PriceTier6")]
        public string PriceTier6 { get; set; } = "0";

        [JsonProperty("PriceTier7")]
        public string PriceTier7 { get; set; } = "0";

        [JsonProperty("PriceTier8")]
        public string PriceTier8 { get; set; } = "0";

        [JsonProperty("PriceTier9")]
        public string PriceTier9 { get; set; } = "0";

        [JsonProperty("PriceTier10")]
        public string PriceTier10 { get; set; } = "0";
