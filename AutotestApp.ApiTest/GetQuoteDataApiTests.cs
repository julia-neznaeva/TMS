...
namespace AutotestApp.ApiTest
{
    ...
    public class GetQuoteDataApiTests: BaseApiTest
    {
        ...
        public void GetQuoteDataAccessorial()
        {
            ...
            IEnumerable<Accessorial> originSiteAccessorialFromDB = _billingAdressService.GetOriginalSiteAccessorials().OrderBy(x=>x.accessorialId);
            ...
            IEnumerable<Accessorial> originNonCommercialFromDB = _billingAdressService.GetOriginalNonCommercialAccessorials().OrderBy(x => x.accessorialId);
            ...
            IEnumerable<Accessorial> originAccessorialFromDB = _billingAdressService.GetOriginalAccessorials().OrderBy(x => x.accessorialId);
            ...
            IEnumerable<Accessorial> destinationAccessorialFromDB = _billingAdressService.GetDestinationAccessorials().OrderBy(x => x.accessorialId);
            ...
            IEnumerable<Accessorial> destinationSiteAccessorialFromDB = _billingAdressService.GetDestinationSiteAccessorials().OrderBy(x => x.accessorialId);
            ...
            IEnumerable<Accessorial> destinationNonCommercialAccessorialFromDB = _billingAdressService.GetDestinationNonCommercialAccessorials().OrderBy(x => x.accessorialId);
            ...
            IEnumerable<Accessorial>nonCommercialAccessorialFromDB = _billingAdressService.GetNonCommercialAccessorials().OrderBy(x => x.accessorialId);
        ...
        public void GetQuoteDataPackageTypes()
        {
            ...
            List<GeneralType>packageTypesFromDB = _billingAdressService.GetPackageType();
        ...
        public void GetQuoteDataHazardPackingTypes()
        {
            ...
            List<GeneralType> hazardPackingTypessFromDB = _billingAdressService.GetHazardPackingTypes();
        ...
        public void GetQuoteDataDisabledDate()
        {
            ...
            List<DisabledDate> disablesDateFromDB = _billingAdressService.GetDisabledDates();
        ...
        public void GetQuoteDateFreightClass()
        {
            ...
            List<GeneralType> freightClassesFromDB = _billingAdressService.GetFreightClass();
        ...
        public void GetSpecialInstructionDefaultText()
        {
            ...
            String textDB = _billingAdressService.GetCustomerInfo("kate.test21@gmail.com").SpecialInstructionDefaultText;
        ...
        public void GetIsRequiredNmfcCode()
        {
            ...
            Boolean IsNmfDb = _billingAdressService.GetCustomerInfo("kate.test21@gmail.com").IsRequiredNmfcCode;
